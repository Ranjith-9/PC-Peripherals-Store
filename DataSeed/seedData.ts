const gamingProducts = [
  ...
  },
  {
    ...
    stock: 10,
    description:
      "The Viper V3 Pro delivers flagship wireless performance with an ergonomic shape trusted by professional players. Its cutting-edge optical sensor ensures outstanding tracking accuracy across all play styles.",
    filters: {
      pollingRate: "8000 Hz",
      connectivity: "Wireless",
      rgb: "No",
